...
public class AutomatedMessagesCommand implements CommandExecutor {
    ...
    @CommandInfo(value = "automsg", minArguments = 1, maxArguments = 3 ,usage = "[action] [interval(s)] [message]" , role = Role.MODERATOR, description = "Set an automated message to be sent every x minutes")
