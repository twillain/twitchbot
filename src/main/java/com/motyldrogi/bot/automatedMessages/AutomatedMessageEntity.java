...
public class AutomatedMessageEntity {
    ...
    private AutomatedMessageEntity(){

    }

    private AutomatedMessageEntity(Builder builder){
    ...
    public static class Builder implements Buildable<AutomatedMessageEntity> {
        ...
        @Override
        public AutomatedMessageEntity build() {
            return new AutomatedMessageEntity(this);
        }
    }
}
